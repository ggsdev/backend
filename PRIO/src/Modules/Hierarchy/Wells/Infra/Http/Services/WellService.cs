    ...
    public class WellService
    {
        ...
        public async Task<CreateUpdateWellDTO> CreateWell(CreateWellViewModel body, User user)
        {
            ...
            var well = new Well
            {
                ...
                StatusOperator = body.IsActive is null || body.IsActive.Value,
                Type = body.Type,
                ...
                Field = field,
                User = user,
                IsActive = body.IsActive is null || body.IsActive.Value,
            };
